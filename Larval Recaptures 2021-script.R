...
aggregate(nest.sub$Nest, by = list(nest.sub$habitat), max, na.rm = TRUE)
aggregate(nest.sub$Nest, by = list(nest.sub$habitat), min, na.rm = TRUE)
aggregate(nest.sub$Nest, by = list(nest.sub$habitat), mean, na.rm = TRUE)
...
grid.text("M", x = unit(0.099, "npc"), y = unit(0.15, "npc"), gp=gpar(fontfamily="Arial", fontsize=12))
grid.text("A", x = unit(0.114, "npc"), y = unit(0.15, "npc"), gp=gpar(fontfamily="Arial", fontsize=12))
grid.text("M", x = unit(0.129, "npc"), y = unit(0.15, "npc"), gp=gpar(fontfamily="Arial", fontsize=12))
